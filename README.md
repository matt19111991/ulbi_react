...
- Пересмотреть все новые redesigned кнопки в сторибук
- Пересмотреть все новые redesigned shared/icon в сторибук
- Пересмотреть изменный sidebar item в сторибук
- Пересмотреть изменный sidebar в сторибук
- Пересмотреть новый app logo компонент в сторибук
- Пересмотреть theme switcher компонент в сторибук
